...
PROTOBUF_NAMESPACE_OPEN
template<> ::cooboc::data::Test* Arena::CreateMaybeMessage<::cooboc::data::Test>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace cooboc {
namespace data {
...
class Test PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cooboc.data.Test) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:cooboc.data.Test)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Test::id() const {
  // @@protoc_insertion_point(field_get:cooboc.data.Test.id)
  return _internal_id();
}
...
inline void Test::set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:cooboc.data.Test.id)
}
