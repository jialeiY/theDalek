...
void DebugWriterIntent::setup() {
    ...
    // mcap_helper::createSchema(cooboc::proto::OdometryTopic::descriptor());
    ...
    // *egoStateTopicSchema_ =
    // mcap_helper::createSchema(cooboc::proto::EgoStateTopic::descriptor());
    ...
    // *trajectoryTopicChannel_ = mcap::Channel("/trajectory", "protobuf",
    // trajectoryTopicSchema_->id); writer_.addChannel(*trajectoryTopicChannel_);
